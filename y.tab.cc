...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_41_4 = 41,                      /* $@4  */
  YYSYMBOL_42_5 = 42,                      /* $@5  */
  YYSYMBOL_for_command = 43,               /* for_command  */
  YYSYMBOL_44_6 = 44,                      /* $@6  */
  YYSYMBOL_45_7 = 45                       /* $@7  */
};
...
{
       0,    47,    47,    50,    53,    57,    57,    71,    77,    86,
      96,   105,   109,   120,   131,   143,   144,   148,   152,   156,
     157,   161,   167,   172,   177,   181,   182,   186,   191,   199,
     204,   198,   220,   225,   219,   241,   246,   240
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GREAT", "GREATGREAT", "TWOGREAT", "GREATAMPERSAND",
  "GREATGREATAMPERSAND", "AMPERSAND", "PIPE", "LESS", "NEWLINE", "IF",
  "FI", "THEN", "LBRACKET", "RBRACKET", "SEMI", "DO", "DONE", "WHILE",
  "FOR", "IN", "$accept", "goal", "arg_list", "cmd_and_args", "$@1",
...
{
      26,    -9,   -12,   -12,    -8,   -12,    17,   -12,    23,   -12,
     -12,     2,    -9,    -9,    -9,   -12,   -12,   -12,   -12,    25,
      49,   -12,   -12,   -12,   -12,    30,   -12,   -12,   -12,   -12,
      44,    46,    47,    57,    65,   -12,    66,   -12,    -9,   -12,
       4,     8,    28,   -12,   -12,   -12,   -12,   -12,   -12,   -12,
      51,    52,    53,    58,    59,    60,   -12,   -12,   -12,    26,
      26,    26,     5,    22,    29,   -12,   -12,   -12
};
...
{
       0,     0,     5,    19,     0,    20,     0,     7,    16,    25,
      27,     0,     0,     0,     0,    26,     4,    29,     1,     0,
      18,    28,    22,    23,    24,     6,     4,     4,     4,     8,
       0,     0,     0,     0,     0,    17,     0,    15,     0,     3,
       0,     0,     0,    10,     9,    11,    13,    12,    14,    21,
       0,     0,     0,     0,     0,     0,    30,    33,    36,     0,
       0,     0,     0,     0,     0,    31,    34,    37
};
...
{
     -12,   -12,    36,    54,   -12,   -12,   -12,   -12,   -12,     0,
     -11,     6,   -12,   -12,   -12,   -12,   -12,   -12,   -12,   -12,
     -12
};
...
{
       0,     6,    25,     7,    16,     8,    37,    20,    38,     9,
      10,    11,    12,    26,    59,    13,    27,    60,    14,    28,
      61
};
...
{
      21,    15,    -2,     1,     3,     2,     1,    39,     2,    17,
       5,    39,    22,    23,    24,     3,     4,    18,     3,     4,
      65,     5,    50,     1,     5,     2,    51,     1,     2,     2,
       1,    39,     2,    39,    19,     3,     4,    66,    49,     3,
       4,     5,     3,     4,    67,     5,    52,    43,     5,    44,
      45,    21,    21,    21,    30,    31,    32,    33,    34,    35,
      46,    36,    40,    41,    42,    62,    63,    64,    47,    48,
      53,    54,    55,    29,    56,    57,    58
};

static const yytype_int8 yycheck[] =
{
      11,     1,     0,     1,    13,     3,     1,     3,     3,    17,
      19,     3,    12,    13,    14,    13,    14,     0,    13,    14,
      15,    19,    18,     1,    19,     3,    18,     1,     3,     3,
       1,     3,     3,     3,    11,    13,    14,    15,    38,    13,
      14,    19,    13,    14,    15,    19,    18,     3,    19,     3,
       3,    62,    63,    64,     5,     6,     7,     8,     9,    10,
       3,    12,    26,    27,    28,    59,    60,    61,     3,     3,
...
{
       0,     1,     3,    13,    14,    19,    26,    28,    30,    34,
      35,    36,    37,    40,    43,    34,    29,    17,     0,    11,
      32,    35,    34,    34,    34,    27,    38,    41,    44,    28,
       5,     6,     7,     8,     9,    10,    12,    31,    33,     3,
      27,    27,    27,     3,     3,     3,     3,     3,     3,    34,
      18,    18,    18,    19,    19,    19,    16,    16,    16,    39,
      42,    45,    36,    36,    36,    15,    15,    15
};
...
#line 57 "shell.y"
             { 
          char * w = (char *) (yyvsp[0].cpp_string)->c_str();
	        //printf("%s\n", w);		
          if (strcmp(w, "exit") == 0) {
            printf("Good bye!!\n");
            exit(1);
...
#line 1216 "y.tab.cc"
  ...
  case 11: /* io_modifier: TWOGREAT WORD  */
#line 106 "shell.y"
      {
...
#line 1224 "y.tab.cc"
  ...
  case 12: /* io_modifier: GREATGREATAMPERSAND WORD  */
#line 110 "shell.y"
            {
      if (Shell::TheShell->_pipeCommand->_outFile != NULL) {
        printf("Ambiguous output redirect.\n");
...
#line 1239 "y.tab.cc"
  ...
  case 13: /* io_modifier: GREATAMPERSAND WORD  */
#line 121 "shell.y"
            {
      if (Shell::TheShell->_pipeCommand->_outFile != NULL) {
        printf("Ambiguous output redirect.\n");
...
#line 1382 "y.tab.cc"
  ...
  case 34: /* while_command: IF LBRACKET $@4 arg_list RBRACKET SEMI THEN $@5 command_list FI  */
#line 231 "shell.y"
        { 
	    Shell::TheShell->_level--; 
	    Shell::TheShell->_ifCommand->insertListCommands( 
...
#line 1412 "y.tab.cc"
  ...
  case 37: /* for_command: IF LBRACKET $@6 arg_list RBRACKET SEMI THEN $@7 command_list FI  */
#line 252 "shell.y"
        { 
	    Shell::TheShell->_level--; 
	    Shell::TheShell->_ifCommand->insertListCommands( 
